...
<img src="resource/images/favicon/lumina-logo.png" alt="Lumina Logo" class="hero-decorative-image" width="300">

### *自由で安心なデジタル空間を、技術の力で実現する*

[![GitHub Org](https://img.shields.io/badge/GitHub-lumina--group-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/lumina-group)
...
**Lumina**(ルミナ)は、監視や検閲、誹謗中傷などが蔓延する現代において、**プライバシー**・**表現の自由**・**心理的安全性**を保障することを目的とした、サイバーセキュリティグループです。
